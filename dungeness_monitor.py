...
# --- CONSTANTS ---
GAUGE_ID = "12048000"
# Stable Legacy URL with specific User-Agent requirements for 2026
URL = f"https://waterservices.usgs.gov/nwis/iv/?format=json&sites={GAUGE_ID}&parameterCd=00060"

# --- LOGIC FUNCTIONS (RESTORED ORIGINAL) ---
...
def fetch_data():
    try:
        # User-Agent is now required by USGS to prevent 403 Forbidden errors
        headers = {
            "User-Agent": "DungenessMonitorApp/2.0",
...
# --- UI GENERATOR (RESTORED ORIGINAL) ---
